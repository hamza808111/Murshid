...
export const assessmentQuestions: AssessmentQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { valueEn: 'Creating art or music', valueAr: 'إنشاء الفن أو الموسيقى' },
  ...
  // === PREFERENCES SECTION ===
  {
    ...
    options: [
      ...
      { valueEn: 'Outdoor or fieldwork', valueAr: 'عمل في الهواء الطلق أو ميداني' },
  ...
  },
  {
    ...
    questionAr: 'هل تفضل العمل مع الناس أم البيانات أم الأشياء؟',
    type: 'multiple-choice',
    options: [
      ...
      { valueEn: 'Working with things (building, designing, repairing)', valueAr: 'العمل مع الأشياء (البناء، التصميم، الإصلاح)' },
